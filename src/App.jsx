    ...
    <div className="flex-1 flex flex-col h-full bg-slate-900 overflow-y-auto hide-scrollbar max-w-2xl mx-auto w-full">
      ...
      <div className="flex-1 p-5 space-y-8 pb-24">
        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            <select value={selectedSpecies} onChange={(e) => setSelectedSpecies(e.target.value)} className={`w-full bg-slate-800 border border-slate-700 rounded-2xl py-4 px-5 text-sm outline-none appearance-none shadow-inner ${selectedSpecies ? 'text-white' : 'text-slate-400'}`}>
          ...
          <div className="relative">
            <select disabled={!selectedSpecies} className={`w-full bg-slate-800 border border-slate-700 rounded-2xl py-4 px-5 text-sm outline-none appearance-none shadow-inner ${!selectedSpecies ? 'opacity-50 cursor-not-allowed text-slate-500' : 'text-white'}`}>
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-slate-900 max-w-5xl mx-auto w-full">
      ...
      <div className="flex-1 overflow-y-auto p-5 hide-scrollbar pb-24">
        <h3 className="text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-4 flex items-center"><CheckCircle size={14} className="mr-1.5 text-emerald-400"/> {t.animalsAtExpos}</h3>
